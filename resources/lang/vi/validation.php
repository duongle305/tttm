...
return [
    ...
    */
    ...
    'gt'                   => [
        'numeric' => 'The này must be greater than :value.',
        'file'    => 'The này must be greater than :value kilobytes.',
        'string'  => 'The này must be greater than :value characters.',
        'array'   => 'The này must have more than :value items.',
    ],
    'gte'                  => [
        'numeric' => 'The này must be greater than or equal :value.',
        'file'    => 'The này must be greater than or equal :value kilobytes.',
        'string'  => 'The này must be greater than or equal :value characters.',
        'array'   => 'The này must have :value items or more.',
    ],
    ...
    'lt'                   => [
        'numeric' => 'The này must be less than :value.',
        'file'    => 'The này must be less than :value kilobytes.',
        'string'  => 'The này must be less than :value characters.',
        'array'   => 'The này must have less than :value items.',
    ],
    'lte'                  => [
        'numeric' => 'The này must be less than or equal :value.',
        'file'    => 'The này must be less than or equal :value kilobytes.',
        'string'  => 'The này must be less than or equal :value characters.',
        'array'   => 'The này must not have more than :value items.',
    ],
    'max'                  => [
