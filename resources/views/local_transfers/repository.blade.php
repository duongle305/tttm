...
@section('title','Điều chuyển kho nội bộ')
@section('vendor_js')
            ...
            <fieldset>
                <div class="row mb-10">
                    <div class="col-md-12">
                        ...
                        <h6 class="grey-300 text-center">Chọn kho để chuyển tài sản vào</h6>
                        <div class="form-group">
                            <label class="col-lg-1 control-label">Kho<span class="text-danger">*</span></label>
                            <div class="col-lg-11">
                                <select data-placeholder="Chọn kho..." class="select" id="step_1_select"></select>
                            </div>
                        </div>
                    </div>
                </div>
