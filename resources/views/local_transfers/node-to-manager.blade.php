...
@section('title','Điều chuyển tài sản từ Node sang Nhân viên quản lý')
@section('vendor_js')
...
@section('content')
    <div class="panel panel-white">
        <div class="panel-heading">
            <h5 class="panel-title">ĐIỀU CHUYỂN GIỮA CÁC NODE VÀ NVQL</h5>
        </div>
        ...
        <form class="steps-validation" action="#">
            ...
            <h6>Chọn Node có tài sản cần chuyển</h6>
            <fieldset>
                <div class="row mb-10">
                    <div class="col-md-12">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#step_2_select').select2({
                minimumInputLength: 1,
                ajax: {
                    url: '/ajax/node-to-manager/get-node',
                    headers: {'X-CSRF-Token': $('input[name="_token"]').attr('value')},
                    type: 'POST',
                    dataType: 'json',
                    data: function (params) {
